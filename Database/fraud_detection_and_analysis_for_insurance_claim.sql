...
--
-- Host: localhost
-- Generation Time: Aug 02, 2022 at 10:46 AM
...
--
-- Database: `fraud_detection_and_analysis_for_insurance_claim`
--
CREATE DATABASE IF NOT EXISTS `fraud_detection_and_analysis_for_insurance_claim` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fraud_detection_and_analysis_for_insurance_claim`;
...
(3, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,8th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#989.4th Cross,Viajayanagar', 'Male');
...
(127, 'Naive Bayes', '50.14208214931543'),
(128, 'SVM', '50.14208214931543'),
(129, 'Logistic Regression', '50.14208214931543'),
(130, 'Decision Tree Classifier', '50.14208214931543'),
(131, 'SGD Classifier', '50.322913975716865');
...
(30, 'Fraud Claim', '100.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_insurance_claim_status`
--

CREATE TABLE IF NOT EXISTS `remote_user_insurance_claim_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Account_Code` varchar(300) NOT NULL,
  `DATE_OF_INTIMATION` varchar(300) NOT NULL,
  `DATE_OF_ACCIDENT` varchar(300) NOT NULL,
  `CLAIM_Real` varchar(300) NOT NULL,
  `AGE` varchar(300) NOT NULL,
  `TYPE` varchar(300) NOT NULL,
  `DRIVING_LICENSE_ISSUE` varchar(300) NOT NULL,
  `BODY_TYPE` varchar(300) NOT NULL,
  `MAKE` varchar(300) NOT NULL,
  `MODEL` varchar(300) NOT NULL,
  `YEAR` varchar(300) NOT NULL,
  `CHASIS_Real` varchar(300) NOT NULL,
  `SUM_INSURED` varchar(300) NOT NULL,
  `POLICY_NO` varchar(300) NOT NULL,
  `POLICY_START` varchar(300) NOT NULL,
  `POLICY_END` varchar(300) NOT NULL,
  `INTIMATED_AMOUNT` varchar(300) NOT NULL,
  `INTIMATED_SF` varchar(300) NOT NULL,
  `EXECUTIVE` varchar(300) NOT NULL,
  `PRODUCT` varchar(300) NOT NULL,
  `POLICYTYPE` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_insurance_claim_status`
--

INSERT INTO `remote_user_insurance_claim_status` (`id`, `Account_Code`, `DATE_OF_INTIMATION`, `DATE_OF_ACCIDENT`, `CLAIM_Real`, `AGE`, `TYPE`, `DRIVING_LICENSE_ISSUE`, `BODY_TYPE`, `MAKE`, `MODEL`, `YEAR`, `CHASIS_Real`, `SUM_INSURED`, `POLICY_NO`, `POLICY_START`, `POLICY_END`, `INTIMATED_AMOUNT`, `INTIMATED_SF`, `EXECUTIVE`, `PRODUCT`, `POLICYTYPE`, `NATIONALITY`, `PREDICTION`, `REG`) VALUES
(1, '5495', '01-11-16 8:18', '27-10-16', 'DU/10/PC/COMP/12781/17', '42', 'RECOVERY CLAIM', '27-04-04', 'HATCH BACK', 'VOLKSWAGEN', 'GOLF', '2015', 'WVWDH2AU6FW083981', '73500', '102090084', '25-08-16', '24-09-17', '9000', '300', 'BR', 'STANDARD', 'COMP', 'EGYPTION', 'Fraud Claim', 'DUBAI'),
(2, '9828', '01-11-16 9:21', '25-10-16', 'DU/10/PC/COMP/12787/17', '40', 'OD Claim', '27-08-06', 'SALOON', 'SUZUKI', 'CIAZ', '2016', 'MA3VC4A11GA151507', '47604', '102082521', '22-05-16', '21-06-17', '6150', '300', 'RAJENDRA', 'STANDARD', 'COMP', 'COMPANY', 'Fraud Claim', 'DUBAI');
